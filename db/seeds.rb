...
cat2 = Category.create(name: "Business", color: "#e0a1ef", user: user1)
cat3 = Category.create(name: "Social", color: "#d88bc6", user: user1)
cat4 = Category.create(name: "Appointments", color: "#ce32f1", user: user1)
cat5 = Category.create(name: "Health", color: "pink", user: user2)
cat6 = Category.create(name: "Business", color: "#e0a1ef", user: user2)
cat7 = Category.create(name: "Social", color: "#d88bc6", user: user2)
cat8 = Category.create(name: "Appointments", color: "#ce32f1", user: user2)
