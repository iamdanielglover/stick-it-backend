...
Note.create(title: "hello", content: "blablabla", category_id: cat1)
Note.create(title: "hi", content: "blabla", category_id: cat2)
Note.create(title: "wow", content: "heyaaaa", category_id: cat2)
Note.create(title: "note", content: "grooooovy", category_id: cat3)
Note.create(title: "crazy", content: "woooooooo", category_id: cat4)
Note.create(title: "doctor", content: "crazytimes", category_id: cat5)
